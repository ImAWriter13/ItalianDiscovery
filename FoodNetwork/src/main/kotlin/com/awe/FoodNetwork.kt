...
open class FoodNetwork : MainAPI() {
    ...
    open var serviceIdentifier: String = "foodnetwork"
    open var category: String = "programmi-food-network"
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse? {
        ...
        val pages =
            response.blocks.filter { it.items.isNotEmpty() && it.type == "collectionBlock" }
                .map { block ->
                    HomePageList(
