...
### Installation
In order to install this repository, paste [this link](https://raw.githubusercontent.com/notALake/Nove/refs/heads/master/repo.json) into the field for the repository URL in CloudStream's *Add repository* menu.
